...
import { propertiesCentroConcordia } from "../../../../data/concordia/propertiesCentroConcordia";
import { Bed, Bath, Star } from "lucide-react";
import Image from "next/image";
import { Button } from "@/components/ui/button";

export default function PropertiesCentroConcordia() {
        ...
        <section className="py-12 bg-slate-200">
            <div className="container mx-auto px-4">
                <h2 className="text-3xl font-bold text-center mb-12 text-blue-800">
                    Zona Centro Concordia
                </h2>

                <div className="grid md:grid-cols-3 gap-6">
                    {propertiesCentroConcordia.map((property) => (
                        <div
                            key={property.id}
